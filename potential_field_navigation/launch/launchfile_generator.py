...
###################################################################################
        ...
        for id in amiroids:
            writeVectorfieldToGridmapNode(file, id, "amiro" + str(id))
...
###################################################################################
        ...
        writeVectorfieldMerger(file, mergerTopics[0] + "_image", mergerTopics[0] + "/fused", "image", finalVectorfieldScope, 1)
